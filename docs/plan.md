...
- Бесплатно максимальный размер файла: 5MB для архива/10MB для обычного фаила (free)
- Платно максимальный размер фаила до 100 MB (реализовать загрузку фаилов более 20мб)
