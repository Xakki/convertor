...
/**
 * Личный кабинет: история конвертаций, квоты/лимиты, данные аккаунта.
 * Повтор/удаление — API `POST /convert/{id}/retry`, `DELETE /convert/{id}`
 * (CNV-8); UI-кнопки в history на этой странице.
 *
 ...
 * GET /api/v1/me). Действия retry/delete доступны только при loggedIn
 * (ROLE_USER JWT); API дополнительно режет ROLE_GUEST.
 */
