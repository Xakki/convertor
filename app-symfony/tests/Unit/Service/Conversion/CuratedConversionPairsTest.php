 ...
 * рассинхрон, если матрица (hardcoded fallback) когда-нибудь изменится и
 * "выбьет" одну из курируемых пар.
 */
final class CuratedConversionPairsTest extends TestCase
{
    public function testEveryCuratedPairIsSupportedByTheRegistry(): void
    {
        $registry = new ConversionRegistry(); // hardcoded fallback (без БД)
