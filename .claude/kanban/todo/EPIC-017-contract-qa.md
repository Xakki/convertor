...
**Description:**
Последовательный поток атомарных карточек одной специализации: `qa`.
...
**Decisions:**
- Эпик выполняется последовательно после предыдущих EPIC; подзадачи принадлежат только `qa`-специалисту.
