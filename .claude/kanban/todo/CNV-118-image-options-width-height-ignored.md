...
- 2026-09-02: Historical (superseded): exact supported/browser inventory и owner approval для browser/animated pairs ещё были открыты; запись superseded одобренным staged browser inventory и promotion карточки в `todo/`. No-upscale вопрос закрыт универсальной migration policy с разрешённым upscaling.
