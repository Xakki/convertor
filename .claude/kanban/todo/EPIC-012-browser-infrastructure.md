### Инфраструктура и egress browser worker
...
**Description:**
Последовательный поток атомарных карточек одной специализации: `infra-security`.
...
**Decisions:**
- Эпик выполняется последовательно после предыдущих EPIC; подзадачи принадлежат только `infra-security`-специалисту.
