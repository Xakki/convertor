### Документация контрактов API и settings
...
**Description:**
Последовательный поток атомарных карточек одной специализации: `docs`.
...
**Decisions:**
- Эпик выполняется последовательно после предыдущих EPIC; подзадачи принадлежат только `docs`-специалисту.
