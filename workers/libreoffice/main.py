...
Endpoints:
  ...
  POST /doc2docx-plain            multipart upload -> .docx body
  POST /doc2text-plain            multipart upload -> .txt  body
  POST /doc2md-plain              multipart upload -> .md   body  (GitHub-flavoured)
